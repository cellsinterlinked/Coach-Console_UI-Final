...
const CardioTable = ({cardioData, loadedWorkout, workoutNum, userId, setCardioData, setError, cardioColumns, selectedRow, setSelectedRow }) => {
...
title={`${loadedWorkout.name} Cardio`}
