...
const Home = ({ DUMMYCHECKINS, navToggle, workouts, diets, fullUserData, currentClient, userId, userRole }) => {
        ...
        <div className="client-list-container">
          ...
          {checkMode === false ? (
            <div className="absurd-box">
              {fullUserData.checkins.filter(checkin => checkin.client === currentClient.id).map((client, index) => (
                <CheckinButton
                  name={client.name}
                  key={index}
