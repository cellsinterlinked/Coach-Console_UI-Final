...
<h3 align="center">Coach Console</h3>

  <p align="center">
    Coach console is a tool for Fitness Trainers and their clientele to track progress over time, create personalized programs, and communicate. 
    <br />
    <a href="https://coachconsole.netlify.app/">View Demo</a>
  </p>
</div>
...
[![Product Name Screen Shot][product-screenshot]](https://res.cloudinary.com/dbnapmpvm/image/upload/v1658358075/Portfolio/Image_7-20-22_at_6.47_PM_wyf7s3.jpg)

Coach console's purpose is to give fitness trainers/nutrition coaches a tool to organize workout and nutrition plans with their clients. Either party may post check-in's to log overall progress as well as send messages to one another.  
<br/>
...
- [ ] Create Workout/Nutrition Templates as starting points
- [ ] Overhaul Exercise Tables 
- [ ] Lists of exercises to choose from with included image or video
- [ ] Overhaul nutrition tables 


See the [open issues](https://github.com/cellsinterlinked/Coach-Console_UI-Final/issues) for a full list of proposed features (and known issues).
...
Project Link: [https://github.com/cellsinterlinked/Coach-Console_UI-Final](https://github.com/cellsinterlinked/Coach-Console_UI-Final)
<br/>
